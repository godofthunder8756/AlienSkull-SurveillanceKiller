...
# Note: Do NOT run 'pip install --upgrade pip' in Termux
# It will break the python-pip package
...
echo ""
echo "Config: ~/.config/alienskull/config.json"
echo "Database: ~/.local/share/alienskull/scans.db"
echo ""
echo "════════════════════════════════════════════"
echo "LEGAL NOTICE:"
echo "Educational & security research only."
echo "Passive scanning - no active attacks."
echo "Comply with local regulations."
echo "════════════════════════════════════════════"
echo ""
